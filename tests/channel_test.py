...
def test_channel_details_check_id(one_user_made_two_channels):
    assert one_user_made_two_channels['first']['channel_id'] == 1
    assert one_user_made_two_channels['second']['channel_id'] == 2
...
def test_channel_details_check_members(one_user_made_two_channels):
    assert one_user_made_two_channels['first']['members'] == [{'channels': [{'channel_id': 1, 'name': 'public'}, {'channel_id': 2, 'name': 'private'}], 
     'email': 'anemail@email.com',  'handle': 'namename',  'id': 1,  'name_first': 'Name',  'name_last': 'Name'}]
    assert one_user_made_two_channels['second']['members'] == [{'channels': [{'channel_id': 1, 'name': 'public'}, {'channel_id': 2, 'name': 'private'}], 
     'email': 'anemail@email.com',  'handle': 'namename',  'id': 1,  'name_first': 'Name', 'name_last': 'Name'}]
...
def test_channel_details_multiple_members(one_user_made_two_channels):
    ...
    assert channel_details_v1(1,1)['members'] == [{'channels': [{'channel_id': 1, 'name': 'public'}, {'channel_id': 2, 'name': 'private'}], 
     'email': 'anemail@email.com',  'handle': 'namename',  'id': 1,  'name_first': 'Name',  'name_last': 'Name'}, {'channels': [{'channel_id': 1, 'name': 'public'}],
     'email': 'notanemail@email.com',  'handle': 'seconduser',  'id': 2,  'name_first': 'Second',  'name_last': 'User'}]
